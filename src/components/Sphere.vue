...
//   return {}
// }
      var breathAnimation = this.anime.play({
        begin: function() {
          for (var i = 0; i < pathLength; i++) {
            aimations.push(this.anime({
      ...
      var introAnimation = this.anime.timeline({
        autoplay: false
      })
      .add({
        ...
        strokeDashoffset: {
          ...
          delay: this.anime.stagger(190, {direction: 'reverse'})
        },
        duration: 2000,
        delay: this.anime.stagger(60, {direction: 'reverse'}),
        easing: 'linear'
      }, 0);

      var shadowAnimation = this.anime({
